...
class WatsonEnv:
    ...
    def get_watson_style_me():
        ...
        cloudant_db_name = os.environ.get(
            "CLOUDANT_DB_NAME") or 'watson_style_me'
        ...
        cloudant_style_me = CloudantStyleMe(
            Cloudant(
                cloudant_username,
                cloudant_password,
                url=CloudantStyleMe.optimize_cloudant_url(cloudant_url),
                connect=True
            ),
            cloudant_db_name
        )
...
if __name__ == "__main__":
    ...
    watsonstyleme = WatsonEnv.get_watson_style_me()
