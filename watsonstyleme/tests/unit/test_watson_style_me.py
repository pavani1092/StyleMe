...
class WOSTestCase(unittest.TestCase):
    ...
    def setUp(self):
        mock.Mock(watson_style_me.os.environ, return_value={})
        self.slack_client = mock.Mock()
        self.assistant_client = mock.MagicMock()
        self.watson_style_me = mock.Mock()
        ...
        self.watson_style_me.context_merge = message_json.message

        self.wos = watson_style_me.WatsonStyleMe(
            'UBOTID',
            self.slack_client,
        ...
        self.sender = watson_style_me.SlackSender(
            self.slack_client, 'sender-channel')

    def test_0(self):

        fake_channel = "fake channel"
        sender = watson_style_me.SlackSender(
    ...
    def test_setup_conversation_workspace_by_name_default(self):
        ...
        wos = watson_style_me.WatsonStyleMe
