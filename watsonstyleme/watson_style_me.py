...
class OnlineStoreCustomer:
    ...
    def get_customer_dict(self):
        """Returns a dict in form usable by our cloudant_style_me DB
...
class WatsonStyleMe:
    def __init__(self, bot_id, slack_client,
        ...
        self.cloudant_style_me = cloudant_style_me
    ...
    def setup_assistant_workspace(assistant_client, environ):
        ...
        if env_workspace_id:
            ...
            for workspace in workspaces:
                ...
                workspace = WatsonStyleMe.get_workspace_json()
    ...
    def customer_from_db(self, user_data):
        ...
        this data and set for this instance of WatsonStyleMe
    ...
    def init_customer(self, sender, user_id):
        ...
        if user_json and 'user' in user_json:
            ...
            if cust:
                user_data = self.cloudant_style_me.find_customer(cust)
                if user_data:
                    ...
                    self.cloudant_style_me.add_customer_obj(self.customer)
    ...
    def get_discovery_response(self, input_text):
        ...
        Formatted response_tuple is saved for WatsonStyleMe to allow item
    ...
    def handle_list_shopping_cart(self):
        ...
        shopping_list = self.cloudant_style_me.list_shopping_cart(cust)
    ...
    def handle_delete_from_cart(self):
        ...
        shopping_list = self.cloudant_style_me.list_shopping_cart(email)
        try:
    ...
    def handle_add_to_cart(self):
        ...
        for index, entry in enumerate(self.response_tuple):
            if index+1 == cart_item:
                ...
                self.cloudant_style_me.add_to_shopping_cart(email, item)
        self.clear_shopping_cart()
    ...
    def run(self):
        ...
        """
        # make sure DB exists
        self.cloudant_style_me.init()

        if self.slack_client and self.slack_client.rtm_connect():

            LOG.info("Watson Style Me bot is connected and running!")
            while True:
