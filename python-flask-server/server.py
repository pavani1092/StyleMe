...
def do_message(message):
    ...
    if not watson:
        ...
        sender.send_message(
            "Sorry. The Watson Style Me is closed (failed to initialize).")

    elif message['data']:
        # Send message to WatsonStyleMe and start a conversation loop.
